...
run_script "hyper_Optimization_2classes.py"

# Uncomment and run additional scripts as needed
# run_script "dnn_classifier_3class.py" "-o outputs -t $timestamp"
# run_script "plot_dnn_output_3classes.py" "-f outputs/$timestamp/output_data_3classes.json -o outputs -t $timestamp"
