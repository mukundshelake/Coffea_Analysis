...
class MyProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        yt2D = (
            ...
            .Integer(0, 2, underflow=False, overflow=False, label="xFlag", name="xFlag")
            .Double()
        )
        yt2D.fill(
            m_tt = mtt,
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default='timeStamp',
        help="Specify the timestamp for book-keeping"
    )
    ...
    outputFile = f"RHSskimmerOutput_{args.timestamp}.coffea"
