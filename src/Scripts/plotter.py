...
plotDictionary = {
    "Fu Distribution": {'xAxis': 'y0', 'yAxis' : 'Fu'},
    "Fd Distribution": {'xAxis': 'y0', 'yAxis' : 'Fd'},
    "Fu_ud Distribution" : {'xAxis' : 'y0', 'yAxis' : 'Fu_ud'},
    "Fd_ud Distribution" : {'xAxis' : 'y0', 'yAxis' : 'Fd_ud'},
    "Du Distribution" : {'xAxis' : 'y0', 'yAxis' : 'Dd'},
    "Fu vs Fd Distribution" : {'xAxis' : 'Fu', 'yAxis' : 'Fd'},
    "Fu_ud vs Fd_ud Distribution" : {'xAxis' : 'Fu_ud', 'yAxis' : 'Fd_ud'},
    "Du vs Dd Distribution" : {'xAxis' : 'Du', 'yAxis' : 'Dd'},
    "FuDu Distribution" : {'xAxis' : 'y0', 'yAxis' : 'FuDu'},
    "FdDd Distribution" : {'xAxis' : 'y0', 'yAxis' : 'FdDd'},
    "FuDu vs FdDd Distribution" : {'xAxis' : 'FuDu', 'yAxis' : 'FdDd'},
}
...
for era in out:
    ...
    for region in regions:
        ...
        for plot in plotDictionary:
            ...
            plt.savefig(os.path.join(region_folder, f"{yAxis}_vs_{xAxis}.png"))
            plt.close()
