	...
	## HLT
        ...
        if isRealData:
            ...
            if 'WJet' not in dataset:
                if 'ttbar' not in dataset:
                    if 'singleT' not in dataset:
                        print(f"Adding Generator wt in {dataset}")
...
# Log the stuff
metaTxt = "Run: Adding Generator weights, except WJets, ttbar and singleT"
