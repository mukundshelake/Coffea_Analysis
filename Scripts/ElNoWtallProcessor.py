...
class NanoProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        output["electron_pt"].fill(ak.flatten(sele.pt, axis=-1))
        output["electron_eta"].fill(ak.flatten(sele.eta, axis=-1))      
...
save(out, "outNoWtall_el.coffea")  # save dictionary into coffea file
